<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateDeleteNotice.aspx.cs" Inherits="BSS.UpdateDeleteNotice" %>
    ...
    <div><span class="dot"></span></div>
     ...
     <div class="bottom">
        <table id="keywords" cellspacing="0" cellpadding="0">
            <thead>
              <tr>
                <th style="border-radius: 5px 0px 0px 5px;"><span>Product Name</span></th>
