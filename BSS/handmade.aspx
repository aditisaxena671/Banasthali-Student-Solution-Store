<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="handmade.aspx.cs" Inherits="BSS.handmade" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>HandMade Gift on Sell</title>
...
<body>
    ...
    <div class="cards_wrap">
      ...
      <div class="card">
        <img src="./Images/Handmade/Hand1.jpg" alt="HandMade" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Shrishti Kumari</h1>
        <p class="price">Starting price 500/-</p>
        <p>Gift something which is unique.</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Handmade/Hand2.jpg" alt="HandMade" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Aditi Saxena</h1>
        <p class="price">Starting price 400/-</p>
        <p>Something Special For Someone.</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Handmade/Hand3.jpg" alt="HandMade" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Tanya Dalal</h1>
        <p class="price">Starting price 600/-</p>
        <p>We Design the handmade gift according to customer.</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Handmade/Hand4.jpg" alt="HandMade" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Unati Tiwari</h1>
        <p class="price">Starting price 300/-</p>
        <p>Giving handmade gift is old one out.</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>
