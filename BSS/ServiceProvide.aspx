<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceProvide.aspx.cs" Inherits="BSS.ServiceProvide" %>
...
<head runat="server">
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com" />
    ...
    <link rel="stylesheet" href="ServiceProvide.css"/>
...
<div class="box-form">
    ...
    <div class="bottom">
	    ...
	    <div class="right">
			...
			<asp:Button ID="Button1" class="button-74" runat="server" Text="New Service Provider" OnClick="Button1_Click"/>
			<p>-------------------OR-------------------</p>
			
			<asp:Button ID="Button2" class="button-74" runat="server" Text="My Services" OnClick="Button2_Click" />
		</div>
    </div>
