<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Painting.aspx.cs" Inherits="BSS.Painting" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Painting on sell</title>
...
<body>
    ...
    <div class="cards_wrap">
      ...
      <div class="card">
        <img src="./Images/Painting/Painting1.jpg" alt="Painting" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Shrishti Kumari</h1>
        <p class="price">Starting price 200/-</p>
        <p>I Draw any design of painting with different colors combination.</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Painting/Painting2.jpg" alt="Painting" style="width:40%; margin-left:25%;margin-top:5%" />
      ...
      <div class="card">
        <img src="./Images/Painting/Painting3.jpg" alt="Painting" style="width:40%; margin-left:25%;margin-top:5%" />
      ...
      <div class="card">
        <img src="./Images/Painting/Painting4.jpg" alt="Painting" style="width:40%; margin-left:25%;margin-top:5%" />
