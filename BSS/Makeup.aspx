<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Makeup.aspx.cs" Inherits="BSS.Makeup" %>
...
<body>
    ...
    <div class="cards_wrap">
      ...
      <div class="card">
        <img src="./Images/Makeupp/Makeup1.jpeg" alt="Makeup" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Shrishti Kumari</h1>
        <p class="price">Starting price 200/-</p>
        <p>Give a Look To Your face.</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Makeupp/Makeup2.jpg" alt="Makeup" style="width:40%; margin-left:25%;margin-top:5%" />
      ...
      <div class="card">
        <img src="./Images/Makeupp/Makeup3.jpg" alt="Makeup" style="width:40%; margin-left:25%;margin-top:5%" />
      ...
      <div class="card">
        <img src="./Images/Makeupp/Makeup4.jpg" alt="Makeup" style="width:40%; margin-left:25%;margin-top:5%" />
