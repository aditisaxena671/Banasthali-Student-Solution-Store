<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mehendi.aspx.cs" Inherits="BSS.Mehendi" %>
...
<body>
    ...
    <div class="cards_wrap">
      ...
      <div class="card">
        <img src="./Images/Mendies/Mehndi1.jpg" alt="Mendi" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Shrishti Kumari</h1>
        <p class="price">Starting price 200/-</p>
        <p>Mendi Design By Shrishti Kumari</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Mendies/Mehndi2.jpg" alt="Mendi" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Aditi Saxena</h1>
        <p class="price">Starting price 300/-</p>
        <p>Mendi Design By Aditi Saxena</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Mendies/Mehndi3.jpg" alt="Mendi" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Tanya Dalal</h1>
        <p class="price">Starting price 200/-</p>
        <p>Mendi Design By Tanya Dalal</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Mendies/Mehndi4.jpg" alt="Mendi" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Unati Tiwari</h1>
        <p class="price">Starting price 300/-</p>
        <p>Mendi Design By Unati Tiwari</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>
