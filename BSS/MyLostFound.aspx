<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyLostFound.aspx.cs" Inherits="BSS.MyLostFound" %>
    ...
    <div class="bottom">
        ...
        <div class="right">
            <a href="MyLostProducts.aspx">
                <button class="button-74" role="button">My Lost Items</button>
            </a>
            <p>-------------------OR-------------------</p>
            <a href="MyFoundProducts.aspx">
                <button class="button-74" role="button">My Found Items</button>
            </a>
        </div>
    </div>
