<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="submitNotice.aspx.cs" Inherits="BSS.submitNotice" %>
...
<div class="box-form">
    ...
    <div class="bottom">
	    ...
	    <div class="right">
			<asp:Button ID="Button1" class="button-74" runat="server" OnClick="Button1_Click" Text="Add Notice"  />

			<p>-------------------OR-------------------</p>

			<asp:Button ID="Button2" class="button-74" runat="server" OnClick="Button2_Click" Text="Update Or Delete" />
