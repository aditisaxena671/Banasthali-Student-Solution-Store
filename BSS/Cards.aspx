<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cards.aspx.cs" Inherits="BSS.Cards" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cards on sell</title>
...
<body>
    ...
    <div class="cards_wrap">
      ...
      <div class="card">
        <img src="./Images/Cards/Card1.jpg" alt="Cards" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Shrishti Kumari</h1>
        <p class="price">Starting price 200/-</p>
        <p>I Draw any design of cards with different colors combination.</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Cards/Card2.jpg" alt="Cards" style="width:40%; margin-left:25%; margin-top:5%" />
      ...
      <div class="card">
        <img src="./Images/Cards/Card3.jpg" alt="Cards" style="width:40%; margin-left:25%; margin-top:5%" />
      ...
      <div class="card">
        <img src="./Images/Cards/Card4.jpg" alt="Cards" style="width:40%; margin-left:25%; margin-top:5%" />
