<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SkinCare.aspx.cs" Inherits="BSS.SkinCare" %>
...
<body>
    ...
    <div class="cards_wrap">
      ...
      <div class="card">
        <img src="./Images/SkinCare/Skin1.jpg" alt="Skin" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Shrishti Kumari</h1>
        <p class="price">Starting price 200/-</p>
        <p>Make Your Skin Happy.</p>
