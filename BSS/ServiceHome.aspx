<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceHome.aspx.cs" Inherits="BSS.ServiceHome" %>
...
<body>
    ...
    <div class="bottom">
	    ...
	    <div class="right">
			...
			<asp:Button ID="Button2" class="button-74" runat="server" Text="Provide Services" OnClick="Button2_Click" />
			<p>-------------------OR-------------------</p>
			<asp:Button ID="Button1" class="button-74" runat="server" Text="Get Services" OnClick="Button1_Click" />
		</div>
