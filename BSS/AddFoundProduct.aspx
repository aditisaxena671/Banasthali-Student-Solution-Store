<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFoundProduct.aspx.cs" Inherits="BSS.AddFoundProduct" %>
...
<head runat="server">
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <link rel="stylesheet" href="./AddFoundProduct.css">
     <script language="C#" runat="server">
         ...
         protected void Submit(object sender, EventArgs e)
         {
             SqlConnection con = new SqlConnection(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=BSSS;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
             {
                 ...
                 {
                      cmd= new SqlCommand("insert into [Found_item](Product_name,Product_description,Place,Product_image,Date_time,Student_id) values (@Product_name,@Product_description,@Place,@Product_image,@Date_time,@Student_id)",con);
                        ...
                        file_product.SaveAs(Server.MapPath("~/Images/FoundItem/")+ProductImage);
                 ...
                 {
                        cmd= new SqlCommand("insert into [Found_item](Product_name,Product_description,Place,Date_time,Student_id) values (@Product_name,@Product_description,@Place,@Date_time,@Student_id)",con);
                        cmd.Parameters.AddWithValue("@Product_name",ProductName.Value);
                        cmd.Parameters.AddWithValue("@Product_description",ProductDescription.Value);
                        cmd.Parameters.AddWithValue("@Place",ProductPlace.Value);
                        cmd.Parameters.AddWithValue("@Date_time",ProductDateTime.Value);
    ...
    <div class="top">
        ...
        <div class="squares">
            ...
            <div class="square-box">
                <div class="typing-demo">Found ownerless item? </div>
            </div>
        </div>
        <div class="circles">
            <i class="fa fa-circle-thin" aria-hidden="true"></i>
            ...
            <div class="login-box">
                <form id="form1" method="post" runat="server">
                    ...
                    <div class="user-box">
                        ...
                        <label>Where did you found the product?</label>
                    </div>
                    ...
                    <div class="user-box">
                        ...
                        <label >When did you found the product?</label>
                    </div>
                    <br />
                    <div class="user-box">
