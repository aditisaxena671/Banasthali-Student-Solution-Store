<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notice.aspx.cs" Inherits="BSS.notice" %>
...
<div class="box-form">
    ...
    <div class="bottom">
	    ...
	    <div class="right">
			<asp:Button ID="Button1" class="button-74" runat="server" OnClick="Button1_Click" Text="Event"  />

			<p>-------------------OR-------------------</p>

			<asp:Button ID="Button2" class="button-74" runat="server" OnClick="Button2_Click" Text="Department's Notice" />
