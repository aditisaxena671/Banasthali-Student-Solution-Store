<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LostFound.aspx.cs" Inherits="BSS.LostFound" %>
...
<head runat="server">
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous"><link rel="stylesheet" href="./LostFound.css">
...
<div class="box-form">
    ...
    <div class="bottom">
        ...
        <div class="right">
            <a href="AllLostProducts.aspx">
                <button class="button-74" role="button">Lost Items</button>
            </a>
            <p>-------------------OR-------------------</p>
            <a href="AllFoundProducts.aspx">
                <button class="button-74" role="button">Found Items</button>
            </a>
        </div>
    </div>
