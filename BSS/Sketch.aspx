<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sketch.aspx.cs" Inherits="BSS.Sketch" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sketch on Sell</title>
...
<body>
    ...
    <div class="cards_wrap">
      ...
      <div class="card">
        <img src="./Images/Sketch/Sketch1.jpg" alt="Sketch" style="width:40%; margin-left:25%;margin-top:5%" />
        <h1>Provider Name: Shrishti Kumari</h1>
        <p class="price">Starting price 200/-</p>
        <p>I Draw any design of Sketch with different looks.</p>
        <p><button>Contact at: 9123456780</button></p>
      </div>

      <div class="card">
        <img src="./Images/Sketch/Sketch2.jpg" alt="Sketch" style="width:40%; margin-left:25%;margin-top:5%" />
      ...
      <div class="card">
        <img src="./Images/Sketch/Sketch3.jpg" alt="Sketch" style="width:40%; margin-left:25%;margin-top:5%" />
      ...
      <div class="card">
        <img src="./Images/Sketch/Sketch4.jpg" alt="Sketch" style="width:40%; margin-left:25%;margin-top:5%" />
