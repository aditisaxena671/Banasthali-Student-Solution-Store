<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="departmentNotice.aspx.cs" Inherits="BSS.departmentNotice" %>
      ...
      <div class="cards_wrap">
		<div class="card_item">
			<div class="card_inner">
				...
				<div class="role_name">Department Of Mathematics And Computing</div>
		...
		<div class="card_item">
			<div class="card_inner">
				...
				<div class="role_name">Department Of Commerce & Management</div>
...
<asp:Button class="button-74" ID="Button2" runat="server" Text="GO &#8680;" OnClick="Button2_Click" />               
		...
		<div class="card_item">
			<div class="card_inner">
				...
				<div class="role_name">Department Of Legal Studies</div>
...
<asp:Button class="button-74" ID="Button3" runat="server" Text="GO &#8680;" OnClick="Button3_Click" />                
		...
		<div class="card_item">
			<div class="card_inner">
				...
				<div class="role_name">Department Of Humanities</div>
