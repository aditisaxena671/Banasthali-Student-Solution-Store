<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyLostProducts.aspx.cs" Inherits="BSS.MyLostProducts" %>
    ...
    <div><span class="dot"></span></div>
     ...
     <div class="topnav">
        <div class="search-container">
          <div class="link">
            <a href="AddLostProduct.aspx">ADD</a>
          </div>
        ...
        <table id="keywords" cellspacing="0" cellpadding="0">
            <thead>
              <tr>
                ...
                <th><span>Place Lost At</span></th>
                <th><span>Lost On:</span></th>
                <th><span></span></th>
                <th><span></span></th>
